    ...
    afterBuildCreated(() {
      if (isMobile) {
        OneSignal.shared.setNotificationOpenedHandler((OSNotificationOpenedResult notification) async {
          log('----------------------');
          log('notification.notification.additionalData!=======: ${notification.notification.additionalData!.length}');
            ...
            Theme(
              ...
              child: SliverAppBar(
                ...
                actions: [
                  ...
                  IconButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => AllLinksScreen(),));
                    },
                    highlightColor: Colors.transparent,
                    splashColor: Colors.transparent,
                    icon: Image.asset(ic_folder, height: 22, width: 22, fit: BoxFit.fitWidth, color: context.iconColor),
                  ),

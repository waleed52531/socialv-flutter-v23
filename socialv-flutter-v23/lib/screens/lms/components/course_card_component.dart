                ...
                Wrap(
                  ...
                  children: [
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        cachedImage(ic_profile, height: 14, width: 14, fit: BoxFit.cover, color: context.iconColor),
                        4.width,
                    ...
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        cachedImage(ic_course, height: 14, width: 20, fit: BoxFit.contain),
                        4.width,
                    ...
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        cachedImage(ic_book, height: 14, width: 14, fit: BoxFit.contain),
                        4.width,
